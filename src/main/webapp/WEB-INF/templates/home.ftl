...
<nav class="top-bar">
	...
	<ul class="right"><li class="has-form"><a class="small radius button" href="<@url value='/project/instance/details'/>">Project</a></li></ul>
	<ul class="right"><li class="has-form"><a class="small radius button" href="<@url value='/schedule/details'/>">Running Schedule</a></li></ul>
</nav>
