...
public class DataConver {
    ...
    private List<LogFileWrapper> getLogFileWrapperWithProjectAndServerBothNull(String date, String path) {
        List<LogFileWrapper> logFileWrappers = new ArrayList<>();
    ...
    private List<LogFileWrapper> getLogFileWrapperWithServerNull(String date, String path, String projectName) {
        List<LogFileWrapper> logFileWrappers = new ArrayList<>();
        Project project = projectService.getProjectByName(projectName);
        if (null == project) {
            throw new IllegalStateException("Project is not existed");
