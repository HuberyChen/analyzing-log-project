...
public class DataValidate {
	...
	public List<LogFileWrapper> initializeLogFileWrappers(
			ActionLogAnalyzingRequest request, String path) {

		String projectName = request.getProjectName();
		String serverName = request.getServerName();
		String date = request.getDate();

		if (!projectName.equals(ServiceConstant.TYPE_ALL)
				&& serverName.equals(ServiceConstant.TYPE_ALL)) {
	...
	private List<LogFileWrapper> getLogFileWrapperWithProjectAndServerAll(
	...
	private List<LogFileWrapper> getLogFileWrapperWithServerAll(String date,
