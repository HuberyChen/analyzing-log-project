...
public class LogFileOperation {
    ...
    public LogFileWrapper decompression(LogFileWrapper logFileWrapper) {
        ...
        logFileWrapper.setNote(logFileWrapper.getNote() + "decompression log is success, log number = " + uncompressionActionLogs.size() + ". ");
        return logFileWrapper;
    ...
    public LogFileWrapper saveActionLogDetail(LogFileWrapper logFileWrapper) {
        ...
        logFileWrapper.setNote(logFileWrapper.getNote() + "analyzing log is success, log number = " + unAnalyzedlogFiles.size() + ". ");
        return logFileWrapper;
    }
