...
import com.quidsi.log.analyzing.scheduler.jobs.ActionLogAnalyzedJob;
...
public class SchedulerConfig extends DefaultSchedulerConfig {
    ...
    protected void configure(JobRegistry registry) {
        ...
        if (isMasterScheduler) {
            ...
            registry.triggerByCronExpression(ActionLogAnalyzedJob.class.getSimpleName(), ActionLogAnalyzedJob.class, schedulerSettings.getLogAnalyzedCron());
        }
    }
}
